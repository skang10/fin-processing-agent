...
**Status:** PDF Inspector adapter, native inspection, immutable native-text persistence, and scoped delivery implemented; dataset evidence and remaining rendering/OCR spike pending
