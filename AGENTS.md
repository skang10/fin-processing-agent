...
Seven manually confirmed synthetic golden cases are frozen in immutable release `v0.1.3`; the seventh combines inert instruction-like document content with a genuine deterministic income-consistency issue, while `v0.1.1` and `v0.1.2` remain unchanged.
