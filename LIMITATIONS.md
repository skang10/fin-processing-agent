...
9. Page-region rendering is not implemented. A region request resolves to the committed full-page render, so a Vision Language Model would receive the whole page rather than a crop.
