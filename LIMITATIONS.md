...
9. Bounded page-region rendering can crop the committed PNG when input minimization or magnification is actually needed. The ordinary small-document path recognizes a page once and persists a precise OCR or VLM bounding box as page-region evidence for original-document highlighting; missing and full-page regions remain visibly page-level. Results sealed before page-region persistence was implemented are immutable and do not retroactively acquire bounding boxes. The optional crop path has not completed immutable derived-artifact acceptance.
