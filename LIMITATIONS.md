...
4. Page classification of the synthetic corpus matches a visible demo heading in committed native text. A page without native text cannot be classified from its own content, so a registered synthetic case falls back to the fixture page-type declaration described under Models and External Services; any other case leaves such a page unclassified and its logical document uncertain.
