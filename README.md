...
The delivered demo drives the harness with a deterministic scripted fake model, and its OCR output and VLM answers are fixture values: they prove orchestration and the bounded page-scoped path, not recognition or Agent quality. Real OCR and VLM tool ports, crop rendering, hardened operating-system isolation, and live-model acceptance of this path remain follow-up work. See [`LIMITATIONS.md`](LIMITATIONS.md).
